...
class MyNotes {
  ...
  deleteNote(e) {
    ...
    jquery__WEBPACK_IMPORTED_MODULE_0___default().ajax({
      ...
      url: "http://fictional-university.local" + "/wp-json/wp/v2/note/" + thisNote.data("id"),
      type: "DELETE",
      success: response => {
        thisNote.slideUp();
  ...
  createNote(e) {
    ...
    jquery__WEBPACK_IMPORTED_MODULE_0___default().ajax({
      ...
      url: "http://fictional-university.local" + "/wp-json/wp/v2/note/",
      type: "POST",
      data: ourNewPost,
      success: response => {
...
class Search {
  ...
  getResults() {
    jquery__WEBPACK_IMPORTED_MODULE_0___default().getJSON("http://fictional-university.local/wp-json/university/v1/search?term=" + this.searchField.val(), results => {
      this.resultsDiv.html(`
        <div class='row'>
          <div class='one-third'>
          ...
          <div class='one-third'>
            ...
            ${results.events.length ? "" : "<p>No events matches that search</p>"}
  ...
  keyPressDispatcher(e) {
    if (e.keyCode == 83) {} else if (e.keyCode == 27) {
      this.closeOverlay();
    }
  }
